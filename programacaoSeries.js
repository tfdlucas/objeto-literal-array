...
var nome_serie = serie_do_dia.nome; // Guardando os dados do objeto series_do_dia em variáveis
var horario_serie = serie_do_dia.horario;
var sinopse_serie = serie_do_dia.sinopse;

console.log("Hoje é dia de " + nome_serie + " ás " + horario_serie); // Exibição da série do dia
